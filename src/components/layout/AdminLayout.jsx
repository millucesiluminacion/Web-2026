    ...
    const navGroups = [
        {
            ...
            items: [
                ...
                { icon: Sliders, label: 'Filtros Avanzados', path: '/admin/filters' },
            ]
        },
        {
            title: 'Contenido',
            items: [
                ...
                { icon: ShieldCheck, label: 'Sellos de Calidad', path: '/admin/quality-seals' },
                { icon: Zap, label: 'Eficiencia Energética', path: '/admin/energy-labels' },
